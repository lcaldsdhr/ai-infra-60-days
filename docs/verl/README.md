...
| 项目 | 上游仓库 | 固定提交 | 本地路径 |
| --- | --- | --- | --- |
| verl | https://github.com/volcengine/verl | `c4b389adadc58ce51cb2b63e70df497ca166d77f` | `third_party/verl` |
...
2. 从 `third_party/verl` 的训练入口追踪配置加载、worker 初始化和资源分配。
3. 阅读 rollout、奖励计算和优势估计的数据流。
4. 对照分布式训练、checkpoint、容错和指标记录实现。
5. 为每个主题按 [课程笔记模板](../templates/lesson-template.md) 记录可复现命令和结论。
